...
export const schema: Schema = {
	users: {
		...
		age: [ColumnType.INT, ColumnConstraint.NOT_NULL],
		...
		sexual_interest: [ColumnType.VARCHAR, ColumnConstraint.NOT_NULL],
		tags_1: [ColumnType.VARCHAR, ColumnConstraint.NOT_NULL],
		tags_2: [ColumnType.VARCHAR, ColumnConstraint.NOT_NULL],
		tags_3: [ColumnType.VARCHAR, ColumnConstraint.NOT_NULL],
