    ...
    return (
        ...
        <div className="bubble-container">
            <div className="bubble left">
                <p>The application that'll help you to find the most suitable partner 💜 Based on several questions and criterions, join us to meet extraordinaries people ! 💜</p>
