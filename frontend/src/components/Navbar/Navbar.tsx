    ...
    return (
            ...
            <div className="container-fluid">
                ...
                <ul className="nav navbar d-flex">
                    {isAuthenticated === true && <li><Link to={`/apiServeur/mymatchaprofile/${id}`} type="button" className="btn btn-info me-2">My Matcha profile</Link></li>}
                    {isAuthenticated === true && <li><Link to="/apiServeur/match" type="button" className="btn btn-info me-2">Mes Match</Link></li>}
                    {isAuthenticated === true && <li><Link to="/apiServeur/allusers" type="button" className="btn btn-info me-2">--x-- All user --x--</Link></li>}
